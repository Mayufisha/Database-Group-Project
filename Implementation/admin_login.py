...
class AdminLoginSystem:
    def __init__(self, root):
        self.root = root
        self.root.title("Fleet Management System - Admin Login")
    ...
    def create_widgets(self):
        ...
        # Login frame
        login_frame = ttk.LabelFrame(self.main_frame, text="Enter Admin Credentials", padding=15)
    ...
    def login(self):
        ...
        if (username in credentials and 
            ...
            # Launch admin portal
            self.root.destroy()
            subprocess.Popen([sys.executable, "admin_portal.py"])
        else:
            self.status_var.set("Invalid admin credentials")
